<!-- Banner -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:1e3c72,100:2a5298&height=250&section=header&text=Hello,%20I'm%20JongMin!&fontSize=55&fontColor=ffffff&animation=fadeIn" />
</p>

<div align="center">

# 👋 안녕하세요, 임베디드 개발자 **유종민**입니다.

### 🧩 Embedded System Developer  
<b>"하드웨어·펌웨어·AI 융합 기반으로 실제 동작하는 시스템을 만드는 개발자"</b>

전자공학을 전공하며 <b>STM32, FPGA, Arduino, ESP-01, Raspberry Pi, 로봇 시스템, 네트워크</b> 등  
임베디드 기반 프로젝트를 설계하고 구현해왔습니다.  
<br>
또한 <b>AI + 임베디드 융합 분야</b>에 집중하여  
LiDAR SLAM 미니카, EMG 기반 스마트 피트니스 분석, 도서 반납 시스템 등  
실제 환경에서 동작하는 시스템 개발 경험을 가지고 있습니다.
...
|-----------|-------------|
| [Oscilloscope Signal Analysis](https://github.com/YJM00/Oscilloscope-study) | UART, I2C, DHT11, Ultrasonic Sensor 등의 프로토콜 오실로스코프로 분석 |
